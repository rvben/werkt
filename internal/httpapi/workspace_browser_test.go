...
func workspaceBrowserFixture(response http.ResponseWriter, request *http.Request) {
	...
	case "/api/v1/automations/test-automation":
		writeBrowserJSON(response, `{
			...
			"triggers":[{"id":"recording-complete","type":"webhook","enabled":true,"config":{"provider":"zoom"}}],"revisions":[{"id":"rev_test","contentHash":"sha256:test","createdAt":"2026-08-23T18:42:00Z","active":true}]
		}`)
	case "/api/v1/runs":
